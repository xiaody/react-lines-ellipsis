...
var LinesEllipsis = function (_React$Component) {
  ...
  _createClass(LinesEllipsis, [{
    ...
    value: function putEllipsis(indexes) {
      ...
      var units = this.units.slice(0, indexes[this.maxLine]);
      ...
      while (ndPrevUnit && (ndEllipsis.offsetHeight > ndPrevUnit.offsetHeight || ndEllipsis.offsetTop > ndPrevUnit.offsetTop)) {
