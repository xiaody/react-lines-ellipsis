...
var responsiveHOC = require('../src/responsiveHOC');
var LinesEllipsis = responsiveHOC()(require('../src/index'));
var HTMLEllipsis = responsiveHOC()(require('../src/html'));
...
var App = function (_Component) {
  ...
  function App(props) {
    ...
    _this.onTextEdit = debounce(_this.onTextEdit.bind(_this), 100);
    _this.onChangeLines = debounce(_this.onChangeLines.bind(_this));
    return _this;
  }
  ...
  _createClass(App, [{
    ...
    value: function renderUnsafe() {
      ...
      return h(
        ...
        ) : h('article', { className: 'ellipsis-html', dangerouslySetInnerHTML: { __html: text } }),
        h('textarea', {
    ...
    key: 'renderSafe',
    value: function renderSafe() {
      var _this3 = this;

      var _state2 = this.state,
          text = _state2.text,
          maxLine = _state2.maxLine,
          useEllipsis = _state2.useEllipsis;
...
},{"../src/html":84,"../src/index":85,"../src/responsiveHOC":86,"./lorem":2,"core-js/fn/array/find":3,"core-js/fn/array/from":4,"core-js/fn/string/repeat":5,"lodash/debounce":71,"preact":78,"raf/polyfill":81}],2:[function(require,module,exports){
'use strict';

module.exports = {
  en: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut,enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.\n\n'.repeat(2).trim(),

  zh: ['《春江花月夜》', '春江潮水连海平　海上明月共潮生', '潋滟随波千万里　何处春江无月明', '江流宛转绕芳甸　月照花林皆似霰', '空里流霜不觉飞　汀上白沙看不见', '江天一色无纤尘　皎皎空中孤月轮', '江畔何人初见月　江月何年初照人', '人生代代无穷已　江月年年只相似', '不知江月待何人　但见长江送流水', '白云一片去悠悠　青枫浦上不胜愁', '谁家今夜扁舟子　何处相思明月楼', '可怜楼上月徘徊　应照离人妆镜台', '玉户帘中卷不去　捣衣砧上拂还来', '此时相望不相闻　愿逐月华流照君', '鸿雁长飞光不度　鱼龙潜跃水成纹', '昨夜闲谭梦落花　可怜春半不逞家', '江水流春去欲尽　江谭落月复西斜', '斜月沉沉藏海雾　碣石潇湘无限路', '不知乘月几人归　落月摇情满江树'].join('\n    '),

  jp: ['体は剣で出来ている', '血潮は鉄で心は硝子', '幾たびの戦場を越えて不敗', 'ただ一度の敗走もなく', 'ただ一度の勝利もなし', '担い手はここに独り', '剣の丘で鉄を鍛つ', 'ならば我が生涯に意味は不要ず', 'この体は', '無限の剣で出来ていた'].join('\n'),

  emoji: '😛 🤑 🤓 😎 🤗 😏 😶 😐 😑 😒 🙄 🤔 😳 😞 😟 😠 😡 😔 '.repeat(20),

  html: '<h5>&#65799;<em>N\u01D0 h\u01CEo \u4F60\u597D</em> <b>how are you</b> \uD83D\uDE04   m\xE1r\u0127aban <b>\u05D4\u05E2\u05DC\u05D0</b></h5>\n    <p>&#65800;CSS is <i>a&omega;esome</i> \u0645\u0641\u062A\u0627\u062D \u0645\u0639\u0627\u064A\u064A\u0631 \u0627\u0644\u0648\u064A\u0628!&rlm;</p>\n    &#65801;yeah!  <a target=_blank href=\'//github.com/xiaody/react-lines-ellipsis\'>Fork me at Github</a>\n    <br>\n    <ol>\n      <li>&#65802;task 1\n      <li>\n        <ul>\n          <li>&#65803;<span style="text-decoration: line-through">task 2.1</span>\n          <li>&#65804;task 2.2\n        </ul>\n      </li>\n      <li>&#65805;task 3\n    </ol>\n    <section style="color: grey">&#65806;\u0434\u043E \u0441\u0432\u0438\u0434\u0430\u043D\u0438\u044F\uFF01( ^_^ )/~</section>\n  '
};
...
},{"../../modules/_core":15,"../../modules/es6.array.find":61}],4:[function(require,module,exports){
require('../../modules/es6.string.iterator');
require('../../modules/es6.array.from');
module.exports = require('../../modules/_core').Array.from;

},{"../../modules/_core":15,"../../modules/es6.array.from":62,"../../modules/es6.string.iterator":63}],5:[function(require,module,exports){
require('../../modules/es6.string.repeat');
module.exports = require('../../modules/_core').String.repeat;

},{"../../modules/_core":15,"../../modules/es6.string.repeat":64}],6:[function(require,module,exports){
...
},{"./_hide":26,"./_wks":59}],8:[function(require,module,exports){
...
},{"./_is-object":32}],9:[function(require,module,exports){
// false -> Array#indexOf
// true  -> Array#includes
...
},{"./_array-species-create":12,"./_ctx":17,"./_iobject":29,"./_to-length":55,"./_to-object":56}],11:[function(require,module,exports){
var isObject = require('./_is-object');
...
},{"./_is-array":31,"./_is-object":32,"./_wks":59}],12:[function(require,module,exports){
...
},{"./_cof":14,"./_wks":59}],14:[function(require,module,exports){
...
},{"./_object-dp":40,"./_property-desc":45}],17:[function(require,module,exports){
...
},{"./_a-function":6}],18:[function(require,module,exports){
...
},{"./_global":24,"./_is-object":32}],21:[function(require,module,exports){
...
},{"./_core":15,"./_ctx":17,"./_global":24,"./_hide":26,"./_redefine":46}],23:[function(require,module,exports){
...
},{"./_descriptors":19,"./_object-dp":40,"./_property-desc":45}],27:[function(require,module,exports){
var document = require('./_global').document;
...
},{"./_iterators":37,"./_wks":59}],31:[function(require,module,exports){
...
},{"./_cof":14}],32:[function(require,module,exports){
module.exports = function (it) {
...
},{"./_an-object":8}],34:[function(require,module,exports){
'use strict';
...
},{"./_hide":26,"./_object-create":39,"./_property-desc":45,"./_set-to-string-tag":47,"./_wks":59}],35:[function(require,module,exports){
'use strict';
...
},{"./_export":22,"./_hide":26,"./_iter-create":34,"./_iterators":37,"./_library":38,"./_object-gpo":42,"./_redefine":46,"./_set-to-string-tag":47,"./_wks":59}],36:[function(require,module,exports){
var ITERATOR = require('./_wks')('iterator');
...
},{"./_an-object":8,"./_dom-create":20,"./_enum-bug-keys":21,"./_html":27,"./_object-dps":41,"./_shared-key":48}],40:[function(require,module,exports){
var anObject = require('./_an-object');
...
},{"./_an-object":8,"./_descriptors":19,"./_ie8-dom-define":28,"./_to-primitive":57}],41:[function(require,module,exports){
var dP = require('./_object-dp');
var anObject = require('./_an-object');
...
},{"./_an-object":8,"./_descriptors":19,"./_object-dp":40,"./_object-keys":44}],42:[function(require,module,exports){
...
},{"./_has":25,"./_shared-key":48,"./_to-object":56}],43:[function(require,module,exports){
var has = require('./_has');
var toIObject = require('./_to-iobject');
...
},{"./_array-includes":9,"./_has":25,"./_shared-key":48,"./_to-iobject":54}],44:[function(require,module,exports){
...
},{"./_enum-bug-keys":21,"./_object-keys-internal":43}],45:[function(require,module,exports){
...
},{"./_core":15,"./_global":24,"./_has":25,"./_hide":26,"./_uid":58}],47:[function(require,module,exports){
...
},{"./_has":25,"./_object-dp":40,"./_wks":59}],48:[function(require,module,exports){
...
},{"./_core":15,"./_global":24,"./_library":38}],50:[function(require,module,exports){
...
},{"./_defined":18,"./_to-integer":53}],51:[function(require,module,exports){
'use strict';
var toInteger = require('./_to-integer');
var defined = require('./_defined');
...
},{"./_defined":18,"./_to-integer":53}],52:[function(require,module,exports){
var toInteger = require('./_to-integer');
var max = Math.max;
var min = Math.min;
...
},{"./_defined":18,"./_iobject":29}],55:[function(require,module,exports){
// 7.1.15 ToLength
var toInteger = require('./_to-integer');
var min = Math.min;
module.exports = function (it) {
...
},{"./_defined":18}],57:[function(require,module,exports){
...
},{"./_global":24,"./_shared":49,"./_uid":58}],60:[function(require,module,exports){
...
},{"./_classof":13,"./_core":15,"./_iterators":37,"./_wks":59}],61:[function(require,module,exports){
'use strict';
...
},{"./_add-to-unscopables":7,"./_array-methods":10,"./_export":22}],62:[function(require,module,exports){
'use strict';
var ctx = require('./_ctx');
var $export = require('./_export');
var toObject = require('./_to-object');
...
},{"./_create-property":16,"./_ctx":17,"./_export":22,"./_is-array-iter":30,"./_iter-call":33,"./_iter-detect":36,"./_to-length":55,"./_to-object":56,"./core.get-iterator-method":60}],63:[function(require,module,exports){
'use strict';
...
},{"./_iter-define":35,"./_string-at":50}],64:[function(require,module,exports){
var $export = require('./_export');
...
},{"./_export":22,"./_string-repeat":51}],65:[function(require,module,exports){
...
},{"./_root":70}],66:[function(require,module,exports){
...
},{"./_Symbol":65,"./_getRawTag":68,"./_objectToString":69}],67:[function(require,module,exports){
(function (global){
...
},{"./_Symbol":65}],69:[function(require,module,exports){
/** Used for built-in method references. */
var objectProto = Object.prototype;
...
},{"./_freeGlobal":67}],71:[function(require,module,exports){
...
},{"./isObject":72,"./now":75,"./toNumber":76}],72:[function(require,module,exports){
/**
...
},{"./_baseGetTag":66,"./isObjectLike":73}],75:[function(require,module,exports){
var root = require('./_root');
...
},{"./_root":70}],76:[function(require,module,exports){
var isObject = require('./isObject'),
...
},{"./isObject":72,"./isSymbol":74}],77:[function(require,module,exports){
(function (process){
...
},{"performance-now":77}],81:[function(require,module,exports){
require('./').polyfill()

},{"./":80}],82:[function(require,module,exports){
'use strict';
...
},{"./common":82,"./helpers":83,"preact":78}],85:[function(require,module,exports){
'use strict';
...
},{"./common":82,"./helpers":83,"preact":78}],86:[function(require,module,exports){
'use strict';
...
},{"lodash/debounce":71,"preact":78}]},{},[1]);
